...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    if (!currentUser) {
        return next(new AppError('The user belonging to this token does no loner exists!', 401));
    }
...
exports.forgotPassword = async (req, res, next) => {
    ...
    try {
        ...
        return next(new AppError('There was error sending the email. Please try again later!'));
